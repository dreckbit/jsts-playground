...
const MONACO_THEMES: Record<string, MonacoTheme> = {
  ...
  firefly: {
    ...
    rules: [
      ...
      { token: "keyword.control", foreground: "a180fd" },
      { token: "storage", foreground: "a180fd" },
      { token: "storage.type", foreground: "a180fd" },
      { token: "number", foreground: "e6b450" },
      { token: "constant.numeric", foreground: "e6b450" },
      { token: "constant.language", foreground: "e6b450" },
      { token: "function", foreground: "859900" },
      { token: "function.call", foreground: "39bae6" },
      { token: "entity.name.function", foreground: "859900" },
      { token: "variable", foreground: "a8aebd" },
      { token: "variable.other", foreground: "a8aebd" },
      { token: "variable.predefined", foreground: "39bae6" },
      ...
      { token: "delimiter.parenthesis", foreground: "b0badd" },
      { token: "delimiter.bracket", foreground: "b0badd" },
      { token: "delimiter.curly", foreground: "b0badd" },
      { token: "delimiter.square", foreground: "b0badd" },
      { token: "string.regexp", foreground: "bfbdb6" },
      { token: "entity.name.tag", foreground: "39bae6" },
      { token: "entity.other.attribute-name", foreground: "fb8c00" },
      { token: "invalid", foreground: "ff0066" },
      { token: "markup.heading", foreground: "c2d94c" },
      { token: "markup.quote", foreground: "95e6cb" },
      { token: "markup.raw", foreground: "f29668" },
    ],
    colors: {
  ...
  "firefly-midnight": {
    ...
    rules: [
      ...
      { token: "keyword.control", foreground: "827db5" },
      { token: "storage", foreground: "827db5" },
      { token: "storage.type", foreground: "827db5" },
      { token: "number", foreground: "e6e600" },
      { token: "constant.numeric", foreground: "e6e600" },
      { token: "constant.language", foreground: "e6b450" },
      { token: "function", foreground: "ff8533" },
      { token: "function.call", foreground: "ffb454" },
      { token: "entity.name.function", foreground: "ff8533" },
      { token: "variable", foreground: "a8aebd" },
      { token: "variable.other", foreground: "a8aebd" },
      { token: "variable.predefined", foreground: "39bae6" },
      ...
      { token: "entity.name.class", foreground: "39bae6" },
      { token: "operator", foreground: "ff6600" },
      { token: "delimiter", foreground: "b3b3b3" },
      { token: "delimiter.parenthesis", foreground: "b3b8c5" },
      { token: "delimiter.bracket", foreground: "b3b8c5" },
      { token: "delimiter.curly", foreground: "b3b8c5" },
      { token: "delimiter.square", foreground: "b3b8c5" },
      { token: "property", foreground: "f29668" },
      { token: "property.name", foreground: "fb8c00" },
      ...
      { token: "markup.heading", foreground: "c2d94c" },
      { token: "markup.quote", foreground: "95e6cb" },
      { token: "markup.raw", foreground: "a4bd00" },
    ],
    colors: {
